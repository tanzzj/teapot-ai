 ...
 * channelType=dingtalk 消费 appKey/appSecret/robotCode；
 * DB 中 app_secret 为 AES-GCM 密文，Service 层解密后回填明文供 ChannelHub 消费。
 */
@Data
public class ChannelConfigDO implements Serializable {
    ...
    private String name;
    /** dingtalk（v1 唯一值，枚举留扩展） */
    private String channelType;
    /** 钉钉应用 ClientID（明文） */
    private String appKey;
    /** 钉钉应用 ClientSecret（DB 为密文） */
